...
class SRMDPreprocessing(object):
    def __init__(
        ...
        pca_matrix = torch.load(
            # "/home/zmdz/name/szy/DCLS-SR-master/pca_matrix/DCLS/pca_matrix.pth", map_location=lambda storage, loc: storage # 我改啦
            "/root/DCLS/DCLS-SR-master/pca_matrix/DCLS/pca_matrix.pth", map_location=lambda storage, loc: storage
        )
